...
<form method="POST"
         action="${ pageContext.servletContext.contextPath }/admin/addDrink"
...
ICE <input type="checkbox" name="ice" value="1"><p>
 ...
 가격<p/>
SMALL  <input type="number" name="smallck" class="w3-input" style="width:90%"/><p>

REGULAR <input type="number" name="regularck" class="w3-input" style="width:90%"/><p>

LARGE <input type="number" name="largeck" class="w3-input" style="width:90%"/><p>
